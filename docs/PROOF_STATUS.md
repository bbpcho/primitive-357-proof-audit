...
The current manuscript is Peter Chocian's pre-submission revision of **A computer-assisted proof**, prepared for his first arXiv submission on this equation. Read [the revised paper](../paper/manuscript.pdf) and the [latest revision record](../audit/reviewer-corrections-2026-09-15/README.md). It includes the expanded author-supplied Claude contribution statement, printed evidence identities, attribution corrections, the rewritten Appendix D, and the clarified place above 1051 and rational two-torsion argument. Bibliography and MSC codes are complete. The fixed companion at [`first-submission-2026-09-15.1`](https://github.com/bbpcho/primitive-357-proof-audit/releases/tag/first-submission-2026-09-15.1) contains the preceding V1 paper and the unchanged computational evidence.

The mathematical audit and computational-baseline status below are distinct from submission readiness. The requested Dahmen reply and third-party redistribution questions remain pending. The author has adopted MIT for his original code and CC BY 4.0 for his original paper and documentation, explicitly excluding third-party material. This resolves his own licensing choice; it does not grant upstream permissions. No arXiv submission or new combined arithmetic replay is claimed for this revision.
